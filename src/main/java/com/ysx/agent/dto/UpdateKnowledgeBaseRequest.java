...
public class UpdateKnowledgeBaseRequest {
    ...
    public UpdateKnowledgeBaseRequest(String name, String description, String category, List<String> tags,
                                      LocalDateTime lastKnownUpdatedAt) {
        this.name = name;
        this.description = description;
        this.category = category;
        this.tags = tags;
        this.lastKnownUpdatedAt = lastKnownUpdatedAt;
    }
    ...
    public LocalDateTime getLastKnownUpdatedAt() {
        return lastKnownUpdatedAt;
    }

    public void setLastKnownUpdatedAt(LocalDateTime lastKnownUpdatedAt) {
        this.lastKnownUpdatedAt = lastKnownUpdatedAt;
    }
}
